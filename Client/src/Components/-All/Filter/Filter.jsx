    ...
    return (
        <div>
            ...
            <div className="filter-list" >
                ...
                <ul>
                    <li className="txt-icon-ingredient" onClick={() => handleClickFilter('Sin Gluten', 1, 'singluten.svg', 'Glutten-Free')} style={clicked1 === true ? { color: '#000', textDecoration: 'underline' } : { color: 'grey' }}>
